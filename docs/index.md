...
Comandos relacionados: *ls, cd, cat, diff, sort, uniq, file*

## Nivel 9

El Sr. Cangrejo es un amante de la criptografía y le gusta jugar con el cifrado César.

Comandos relacionados: *ls, cd, cat, tr, diff, sort, uniq, file*
...
Comandos relacionados: *ls, cd, cat, file, tr, base64, xxd, md5sum*
...
Comandos relacionados: *ls, cd, mkdir, cp, cat, file, tar, xxd, gzip, gunzip, bzip2, bunzip2*
...
Comandos relacionados: *ls, cd, cat, file, grep, cut, xargs, md5sum, sha256*
...
Comandos relacionados: *ls, cd, cat, ssh*

## Nivel 14

Este usuario pertenece a un grupo secudario muy, pero que muy peculiar.

Comandos relacionados: *ls, cd, cat, file, id*
...
Comandos relacionados: *ls, cd, cat, git clone, git log, git diff*
